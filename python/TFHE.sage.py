...
_sage_const_604 = Integer(604); _sage_const_2 = Integer(2); _sage_const_15 = Integer(15); _sage_const_32 = Integer(32); _sage_const_1 = Integer(1); _sage_const_0p99 = RealNumber('0.99'); _sage_const_0p292 = RealNumber('0.292'); _sage_const_0p265 = RealNumber('0.265')# To reproduce the estimate run this snippet on http://aleph.sagemath.org/
from sage.all import load, sqrt, RR, ZZ, pi, oo
load('https://bitbucket.org/malb/lwe-estimator/raw/HEAD/estimator.py')

n = _sage_const_604                 # ciphertext dimension (also, key entropy)
