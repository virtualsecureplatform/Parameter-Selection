...
_sage_const_1024 = Integer(1024); _sage_const_2 = Integer(2); _sage_const_26 = Integer(26); _sage_const_32 = Integer(32); _sage_const_1 = Integer(1); _sage_const_0p99 = RealNumber('0.99'); _sage_const_0p292 = RealNumber('0.292'); _sage_const_0p265 = RealNumber('0.265')# To reproduce the estimate run this snippet on http://aleph.sagemath.org/
