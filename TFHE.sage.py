...
_sage_const_635 = Integer(635); _sage_const_2 = Integer(2); _sage_const_15 = Integer(15); _sage_const_16 = Integer(16); _sage_const_0 = Integer(0); _sage_const_1 = Integer(1); _sage_const_0p99 = RealNumber('0.99'); _sage_const_0p292 = RealNumber('0.292'); _sage_const_0p265 = RealNumber('0.265')# To reproduce the estimate run this snippet on http://aleph.sagemath.org/
...
q = _sage_const_2 **_sage_const_16                # for compatibility only
