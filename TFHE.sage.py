...
_sage_const_1024 = Integer(1024); _sage_const_2 = Integer(2); _sage_const_25 = Integer(25); _sage_const_27 = Integer(27); _sage_const_0 = Integer(0); _sage_const_1 = Integer(1); _sage_const_0p99 = RealNumber('0.99'); _sage_const_0p292 = RealNumber('0.292'); _sage_const_0p265 = RealNumber('0.265')# To reproduce the estimate run this snippet on http://aleph.sagemath.org/
from sage.all import load, sqrt, RR, ZZ, pi, oo
load('https://bitbucket.org/malb/lwe-estimator/raw/HEAD/estimator.py')

n = _sage_const_1024                 # ciphertext dimension (also, key entropy)
sd = _sage_const_2 **(-_sage_const_25 )            # noise standard deviation
alpha = sqrt(_sage_const_2 *pi)*sd    # estimator defines noise rate = sqrt(2pi).stdev
q = _sage_const_2 **_sage_const_27                # for compatibility only
