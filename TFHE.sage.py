...
_sage_const_512 = Integer(512); _sage_const_2 = Integer(2); _sage_const_29 = Integer(29); _sage_const_64 = Integer(64); _sage_const_0 = Integer(0); _sage_const_1 = Integer(1); _sage_const_0p99 = RealNumber('0.99'); _sage_const_0p292 = RealNumber('0.292'); _sage_const_0p265 = RealNumber('0.265')# To reproduce the estimate run this snippet on http://aleph.sagemath.org/
from sage.all import load, sqrt, RR, ZZ, pi, oo
load('https://bitbucket.org/malb/lwe-estimator/raw/HEAD/estimator.py')

n = _sage_const_512                 # ciphertext dimension (also, key entropy)
sd = _sage_const_2 **(-_sage_const_29 )            # noise standard deviation
